...
Авто-создание прогноза срабатывает после выбора героя стримером, а не на старте матча. Перед созданием DotaStreamKit проверяет, что Twitch-стрим сейчас online; если канал offline, автоматический прогноз не создается.
